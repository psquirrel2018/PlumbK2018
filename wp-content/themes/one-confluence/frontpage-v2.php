...
?>
    ...
    <div id="main-container" class="container-fluid">
        ...
        <div class="col-sm-5 col-md-4 col-lg-5 col-lg-push-1 text-overlay-left clearfix" style="padding: 80px 0 80px 80px;">
        ...
        <div class="col-sm-7 col-md-7 col-lg-5 col-lg-push-1">
            <img src="<?= $imageOne; ?>" class="img-responsive desaturate2" style="width:75%;padding:30px; margin:90px 0 0 60px;">
        </div>
        </section>
        <?php } ?>
