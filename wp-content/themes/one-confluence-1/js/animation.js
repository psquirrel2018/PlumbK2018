...
var speedFactor = 0.1; //to do swing animation faster or slowly. Calculated in function initAnimation 
...
var phases = [ {d : pendulum[1], t : 500, bezier : mina.easeInOutQuad    } 
              ,{d : pendulum[5], t : 450, bezier : mina.easeInOutQuad    } 
              ,{d : pendulum[2], t : 400, bezier : mina.easeInOutQuad    } 
              ,{d : pendulum[4], t : 300, bezier : mina.easeInOutQuad    } 
              ,{d : pendulum[3], t : 0, bezier : mina.easeInOutQuad    } //original size 
];

var timings = {whole : 0,
              logo : 800, //timings for logo drawings
        brandDelay : 1000, // delay before brand  drawings
        spellbrand : 50, //timings for drawing of each letters of brand name
...
function initAnimation (obj) {
  ...
  var underline = animSvg.rect(20, 75, 0, 4, 2, 2)
                .attr({fill : "#006BAD"});
var c = animSvg.circle(120, 77, 0)  //used to be 1000 changed by scott taylor
                .attr({fill : "#006BAD", opacity : 1})
                .animate({r:60, opacity : 1}, timings.whole*0.85, mina.easein, function(){underline.animate({x : 20, width : 390}, obj.wrtng*1000 , mina.easeinout)});
