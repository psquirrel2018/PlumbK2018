...
initAnimation({
    time : 3, // sec., timing of pendulum swing
    wrtng: 1, // sec.
...
;(function($, window, ScrollReveal, undefined){
    ...
    scrollReveal.reveal($('.text-overlay2', '#art').get(0), {
...
//            Visual Aid: https://scrollrevealjs.org/assets/viewoffset.png
    ...
    scrollReveal.reveal($('.text-overlay2', '#science').get(0), {
        //            'bottom', 'left', 'top', 'right'
        origin      : 'bottom',
...
//            Visual Aid: https://scrollrevealjs.org/assets/viewoffset.png
    ...
    scrollReveal.reveal($('.text-overlay2', '#creative').get(0), {
        //            'bottom', 'left', 'top', 'right'
        origin      : 'bottom',
...
//            Visual Aid: https://scrollrevealjs.org/assets/viewoffset.png
    ...
    scrollReveal.reveal($('.text-overlay2', '#solutions').get(0), {
        //            'bottom', 'left', 'top', 'right'
        origin      : 'bottom',
