...
function onepage_scripts() {
    ...
    wp_enqueue_script('flip', get_template_directory_uri() . '/js/jquery.flip.min.js', array('jquery'), '1.0.0', true );
    ...
    wp_enqueue_script('waypoints', get_template_directory_uri() . '/js/jquery.waypoints.js', array('jquery'), '', true);
